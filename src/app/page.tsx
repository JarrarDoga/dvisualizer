...
const supportedFormats = [
  { icon: FileSpreadsheet, label: 'Excel (.xlsx, .xls)', color: 'text-green-600' },
  { icon: FileText, label: 'CSV & TSV', color: 'text-blue-600' },
  { icon: FileJson, label: 'JSON', color: 'text-amber-600' },
  { icon: FileText, label: 'XML', color: 'text-purple-600' },
];
